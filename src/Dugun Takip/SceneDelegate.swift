...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        // Ekran kilidi açıksa öne gelince biyometri doğrulaması iste.
    ...
    func sceneDidEnterBackground(_ scene: UIScene) {
        ...
        // Ekran kilidi açıksa arka plana alınınca anında kapak koy (uygulama
        // değiştiricide içerik görünmesin); öne gelince doğrulama istenir.
